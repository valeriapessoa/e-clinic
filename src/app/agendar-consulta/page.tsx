  ...
  const faqs = [
    {
      ...
      answer:
        "Você pode cancelar ou remarcar sua consulta pelo portal online ou pelo telefone.",
    },
    {
      question: "Quais são os horários disponíveis para agendamento?",
      answer:
        "Os horários variam conforme o especialista. Verifique as opções ao agendar online.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Aceitamos cartões de crédito, débito e pagamentos via aplicativos.",
    },
  ];

  const healthTips = [
    {
      tip: "Beba 2 litros de água por dia.",
      image: "/images/agendar-consulta/img-5.jpg",
    },
    {
      tip: "Exercite-se regularmente.",
      image: "/images/agendar-consulta/img-6.jpg",
    },
    {
      tip: "Alimente-se de forma balanceada.",
      image: "/images/agendar-consulta/img-7.jpg",
    },
    {
      tip: "Durma 7-8 horas por noite.",
      image: "/images/agendar-consulta/img-8.jpg",
    },
    {
      tip: "Evite alimentos processados.",
      image: "/images/agendar-consulta/img-9.png",
    },
    {
      tip: "Pratique meditação para reduzir o estresse.",
      image: "/images/agendar-consulta/img-10.jpg",
    },
  ];
    ...
    <main>
      ...
      <section className={`container ${styles.cardContainer}`}>
        <div className={styles.card}>
          <img
            src="/images/agendar-consulta/img-2.png"
        ...
        <div className={styles.card}>
          <img
            src="/images/agendar-consulta/img-3.png"
            className={styles.icons}
            alt="Horário"
          />
        ...
        <div className={styles.card}>
          <img
            src="/images/agendar-consulta/img-4.png"
            className={styles.icons}
            alt="Praticidade"
          />
